...
- [`is_installable()`](https://rgt47.github.io/zzrenvcheck/reference/is_installable.md)
...
- [`remove_from_renv_lock()`](https://rgt47.github.io/zzrenvcheck/reference/remove_from_renv_lock.md)
